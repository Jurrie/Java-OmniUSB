 ...
 */
public final class Usb4JavaUsbServices extends UsbImplementationService
{
	/**
	 ...
	 */
	public Usb4JavaUsbServices() throws UsbException
	{
		/**
		...
		deviceManager = new Usb4JavaUsbDeviceManager(this, UsbServiceInstanceConfiguration.SCAN_INTERVAL, UsbServiceInstanceConfiguration.USE_USBDK);
		deviceManager.start();
	}
