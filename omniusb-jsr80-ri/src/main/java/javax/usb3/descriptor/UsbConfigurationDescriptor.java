 ...
 */
// Based on org.usb4java:usb4java-javax:1.3.0#org.usb4java.javax.descriptors.SimpleUsbConfigurationDescriptor
...
public class UsbConfigurationDescriptor extends AUsbDescriptor implements IUsbConfigurationDescriptor
{
	...
	{
		return bmAttributes != null ? bmAttributes.asByte() : null;
	}
	...
	public int hashCode()
	{
		...
		hash += 73 * hash + Objects.hash(bmAttributes);
		hash += 73 * hash + bMaxPower;
		return hash;
	}
