 ...
 */
// Based on org.usb4java:usb4java-javax:1.3.0#org.usb4java.javax.descriptors.SimpleUsbInterfaceDescriptor
 ...
 */
public class UsbInterfaceDescriptor extends AUsbDescriptor implements IUsbInterfaceDescriptor
{
	/**
	...
	{
		return bInterfaceClass.getByteCode();
	}
	...
	public int hashCode()
	{
		...
		hash += 67 * hash + bInterfaceNumber;
		hash += 67 * hash + bAlternateSetting;
		hash += 67 * hash + bNumEndpoints;
		hash += 67 * hash + Objects.hashCode(bInterfaceClass);
		hash += 67 * hash + bInterfaceSubClass;
		hash += 67 * hash + bInterfaceProtocol;
		hash += 67 * hash + iInterface;
		return hash;
	}
