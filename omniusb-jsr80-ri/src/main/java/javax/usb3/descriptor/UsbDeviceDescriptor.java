 ...
 */
// Based on org.usb4java:usb4java-javax:1.3.0#org.usb4java.javax.descriptors.SimpleUsbDeviceDescriptor
 ...
 */
public class UsbDeviceDescriptor extends AUsbDescriptor implements IUsbDeviceDescriptor
{
	/**
	...
	{
		return bDeviceClass.getByteCode();
	}
	...
	public int hashCode()
	{
		...
		hash += 61 * hash + bcdUSB;
		hash += 61 * Objects.hashCode(bDeviceClass);
		hash += 61 * hash + bDeviceSubClass;
		hash += 61 * hash + bDeviceProtocol;
		hash += 61 * hash + bMaxPacketSize0;
		hash += 61 * hash + idVendor;
		hash += 61 * hash + idProduct;
		hash += 61 * hash + bcdDevice;
		hash += 61 * hash + iManufacturer;
		hash += 61 * hash + iProduct;
		hash += 61 * hash + iSerialNumber;
		hash += 61 * hash + bNumConfigurations;
		return hash;
	}
	...
	public String toString()
	{
		return String.format("USB Device Descriptor:%n"
				...
				(short) (bDeviceClass() & 0xff),
				deviceClass().getDescription(),
