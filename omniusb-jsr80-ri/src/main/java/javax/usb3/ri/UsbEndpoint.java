 ...
 */
public abstract class UsbEndpoint implements IUsbEndpoint
{
	/**
	 ...
	 */
	protected UsbEndpoint(final IUsbInterface usbInterface, final IUsbEndpointDescriptor descriptor)
	{
	...
	protected abstract IUsbPipe createUsbPipe();
	...
	{
		return descriptor.endpointAddress().getDirection();
	}
	...
	{
		return EDataFlowtype.fromByte(descriptor.bmAttributes());
	}
