 ...
 */
public final class UsbServicesListenerList extends UsbEventListenerList<IUsbServicesListener> implements IUsbServicesListener
{
	/**
	 * Constructs a new USB services listener list.
	 */
	public UsbServicesListenerList()
	{
		super();
	}
