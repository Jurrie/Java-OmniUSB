 ...
 */
// Based on org.usb4java:usb4java-javax:1.3.0#org.usb4java.javax.RootHub
 ...
 */
public class UsbRootHub implements IUsbHub, IUsbPorts, IUsbDeviceWithId
{
	/**
	...
	@Override
	public void setActiveUsbConfigurationNumber(byte number) throws UsbException
	{
		if (number != 1)
		{
