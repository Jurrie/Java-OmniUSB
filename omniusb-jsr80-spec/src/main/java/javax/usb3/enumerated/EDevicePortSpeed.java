...
/**
 * Enumeration of recognized speeds encoded into a SuperSpeed USB Device Capability descriptor.
 * <p>
 * See 9.6.2.2 SuperSpeed USB Device Capability, wSpeedsSupported of the USB 3.1 spec.
 *
...
public enum EDevicePortSpeed
{
	...
	/**
	 * The bitmap encoding of the speed supported by this device.
	 */
	private final byte byteCode;

	private EDevicePortSpeed(final byte byteCode)
	{
	...
	/**
	 * Get the supported speed from the wSpeedsSupported value returned by the operating system.
	 *
	 * @param wSpeedsSupported
	 * @return
	 */
	public static EDevicePortSpeed speedSupported(final short wSpeedsSupported)
	{
	...
	/**
	 * Get a list of supported speeds from the wSpeedsSupported value returned by the operating system.
	 *
	 * @param wSpeedsSupported Bitmap encoding of the speed supported by this device. (Expect 1, 2, 3, 4 from the operating system.)
	 * @return a non-null but possibly empty ArrayList instance
	 */
	public static List<EDevicePortSpeed> speedsSupported(final short wSpeedsSupported)
	{
