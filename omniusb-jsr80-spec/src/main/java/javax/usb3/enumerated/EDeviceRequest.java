...
public enum EDeviceRequest
{
	 ...
	 * <ul>
	 * <li>bmRequestType : DEVICE_TO_HOST [DEVICE, INTERFACE, ENDPOINT]</li>
	 * <li>bRequest : GET_STATUS</li>
	 * <li>wValue : Zero</li>
	 * <li>wIndex : DEVICE, INTERFACE, ENDPOINT</li>
	 * <li>wLength : Two</li>
	 * <li>Data : Device,Interface, orEndpointStatus</li>
	 * </ul>
	 ...
	 * <li>wLength : Two</li>
	 * <li>Data : Device, Interface, or Endpoint Status</li>
	 * </ul>
	 * <p>
	 ...
	 * <ul>
	 * <li>bmRequestType : HOST_TO_DEVICE [DEVICE, INTERFACE, ENDPOINT]</li>
	 ...
	 * <ul>
	 * <li>bmRequestType : HOST_TO_DEVICE [DEVICE]</li>
	 ...
	 * descriptor exists
	 * <ul>
	 * <li>bmRequestType : DEVICE_TO_HOST [DEVICE]</li>
	 ...
	 * <li>wIndex : Zero</li>
	 * <li>wLength : One</li>
	 * <li>Data : Configuration Value</li>
	 * </ul>
	 ...
	 * interface.
	 * <ul>
	 * <li>bmRequestType : DEVICE_TO_HOST [INTERFACE]</li>
	 * <li>bRequest : GET_INTERFACE</li>
	 * <li>wValue : Zero</li>
	 * <li>wIndex : Interface</li>
	 * <li>wLength : One</li>
	 * <li>Data : Alternate Setting</li>
	 * </ul>
	 ...
	 * specified interface.
	 * <ul>
	 * <li>bmRequestType : HOST_TO_DEVICE [INTERFACE]</li>
	 ...
	 * frame.
	 * <ul>
	 * <li>bmRequestType : HOST_TO_DEVICE [ENDPOINT]</li>
	 * <li>bRequest : SYNCH_FRAME</li>
	 * <li>wValue : Zero</li>
	 * <li>wIndex : Endpoint</li>
	 * <li>wLength : Two</li>
	 * <li>Data : Frame Number</li>
	 * </ul>
	 ...
	 * <li>wIndex : Interface</li>
	 * <li>wLength : Six</li>
	 * <li>Data : Exit Latency Values</li>
	 * </ul>
	...
	private EDeviceRequest(final byte byteCode)
	{
	 ...
	 */
	public static EDeviceRequest fromByteCode(final byte byteCode)
	{
