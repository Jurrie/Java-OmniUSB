...
public enum EDescriptorType
{
	...
	private EDescriptorType(final byte byteCode, final int length)
	{
	 ...
	 */
	public short getWValue(final byte index)
	{
	 ...
	 */
	public static EDescriptorType fromBytecode(final byte bytecode)
	{
