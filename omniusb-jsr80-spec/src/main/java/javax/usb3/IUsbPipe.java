...
public interface IUsbPipe
{
	...
	/**
	 * Stop a single IRP submission in progress.
	 * <p>
	 * This will abort the IRP submission in progress on the pipe.
	 * If the IRP is already being processed, it is aborted.
	 * The submission not be pending after this returns.
	 *
	 * @exception UsbNotActiveException If the pipe is not
	 *                {@link #isActive() active}.
	 * @exception UsbNotOpenException If the pipe is not
	 ...
	 *                disconnected.
	 */
	void abortSubmission(final IUsbIrp irp) throws UsbNotActiveException, UsbNotOpenException, UsbDisconnectedException;
