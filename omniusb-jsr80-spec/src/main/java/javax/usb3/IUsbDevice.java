...
public interface IUsbDevice extends Comparable<IUsbDevice>
{
	 ...
	 *
	 * @param number the byte code address of the configuration value
	...
	/**
	 * Close this IUsbDevice.
	 * <p>
	 * This releases any resources held by this IUsbDevice. For example: closes the UsbControlIrpQueue.
	 */
	public void close();
	...
	/**
	 * Stop a single control IRP submission in progress.
	 * <p>
	 * This will abort the control IRP submission in progress on the pipe.
	 * If the control IRP is already being processed, it is aborted.
	 * If not, it can just be removed from the queue.
	 * The submission will not be pending after this returns.
	 *
	 * @exception UsbException If an error occurs.
	 * @exception UsbDisconnectedException If this device has been disconnected.
	 */
	public void abortSubmission(IUsbControlIrp irp) throws UsbDisconnectedException, UsbException;
	 ...
	 * timeout (in milliseconds) value that this function should wait before giving
	 ...
	 * implementation. The {@code timeout} timeout (in milliseconds) value that
