...
public interface IUsbServices
{
	 ...
	 *                javax.usb.
	 */
	IUsbHub getRootUsbHub() throws UsbException, SecurityException;
	 ...
	 */
	void addUsbServicesListener(IUsbServicesListener listener);
	 ...
	 * @param listener The IIUsbServicesListener.
	 */
	void removeUsbServicesListener(IUsbServicesListener listener);
